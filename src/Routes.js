  ...
  return (
    <Switch>
      ...
      <PublicRoute
        ...
        exact
        layout={Simple}
        path="/home/:name_channel"
      />
      <PublicRoute
        component={View.CallbackOauth}
        exact
        layout={Simple}
        header={false}
        path="/callback_oauth"
      ...
      <PublicRoute
        ...
        exact
        layout={Simple}
        path="/loja/:name_channel"
      />
      <PublicRoute
        component={View.LoginAdmin}
        exact
        layout={Simple}
        header={false}
        path="/login"
      ...
      />
      <PrivateRoute
        component={View.LojaConfig}
        exact
        layout={Dashboard}
        path="/dashboard/loja"
      />
      <PrivateRoute
        component={View.CreateProduct}
        exact
        layout={Dashboard}
      ...
      <PrivateRoute
        ...
        exact
        layout={Dashboard}
        path="/dashboard/product/edit/:id_product"
      />
      <PrivateRoute
        component={View.DetailProduct}
        exact
        layout={Dashboard}
        path="/dashboard/product/detail/:id_product"
      />
      <PrivateRoute
        component={View.UserConfigDashBoard}
        exact
        layout={Dashboard}
        path="/dashboard/:id_user/config"
      />
      <PrivateRoute
        component={View.ListResgatePoints}
        exact
        layout={Dashboard}
        path="/dashboard/resgatePontos"
      />
      <PrivateRoute
        component={View.ListResgateProdutos}
        exact
        layout={Dashboard}
        path="/dashboard/resgateProdutos"
      />
      <PrivateRoute
        component={View.ListResgateProdutosPendentes}
        exact
        layout={Dashboard}
        path="/dashboard/resgateProdutosPendentes"
      />
      <PrivateRoute
        component={View.ConfigRewards}
        exact
        layout={Dashboard}
        path="/dashboard/rewards"
      />
      <PrivateRoute
        component={View.CreateReward}
        exact
        layout={Dashboard}
        path="/dashboard/rewards/create"
      />

      <PrivateRoute
        component={View.ListChannels}
        exact
        layout={Dashboard}
      ...
      <PrivateRoute
        component={View.Roleta}
        exact
        layout={Simple}
        path="/roleta/:name_channel"
      />
