...
import { DeatilProductInfo } from './components';
...
function DetailProduct({history}) {
                        ...
                        (
                            <ContentBodyDash>
                                ...
                                />
                                {
                                    product&&
                                    (
                                        <DeatilProductInfo product={product} editProduct={editProduct} deleteStickerProduct={deleteStickerProduct}/>
                                    )
                                }
                            </ContentBodyDash>
                        )
